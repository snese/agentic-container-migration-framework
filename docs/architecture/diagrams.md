...
flowchart LR
    subgraph SRC["Source adapters (read)"]
        AV[Anthos<br/>on VMware]:::ready
        AG[Anthos<br/>on GCP]:::planned
...
flowchart LR
    subgraph CUST["Customer environment (trust boundary)"]
        K[Anthos / OCP / Rancher<br/>cluster API + vCenter]
...
flowchart LR
    ...
    subgraph SRC2["Source (Anthos / OCP / on-prem)"]
