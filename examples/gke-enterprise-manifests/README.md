# Anthos manifest test fixtures (GKE Enterprise on VMware source)
...
[`examples/gke-enterprise-vmware-to-eks/`](../gke-enterprise-vmware-to-eks/).
...
yq '.metadata.annotations["eks.amazonaws.com/role-arn"] =
  ...
  examples/gke-enterprise-manifests/01-deployment-workload-identity.yaml
```
