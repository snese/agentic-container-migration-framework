...
ACME Corp operates **5 GKE Enterprise on VMware clusters** (`acme-prod-anthos-1`, `acme-prod-anthos-2`,
...
Tied to [GKE Enterprise on VMware source adapter — Known gotchas](../../adapters/source/gke-enterprise-vmware/README.md):
